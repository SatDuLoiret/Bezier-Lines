Constant 4 in Bezier cubic:
	...
	Start & end points are A & D. Controls points B & C. Recurse Casteljau points E, F, G, H, I. Recurse résult M. Point O is center vector AD.
	
	Use this constant for calc controls points position, in drawnig editor, when user drag the line.
	
	The file Constant4.swf démonstrate the constant.
